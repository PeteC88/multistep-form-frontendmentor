    ...
    <section class="card-wrapper">
        <card>
            <section class="form-container" aria-label="step2 form">
                ...
                <p class="form-cotainer__description">You have theption of monthly or yearly billing</p>
...
const emit = defineEmits(['togglePlans', 'choosePlanAction', 'choseMonthlyPlan', 'choseYarlyPlan']) 
...
onMounted(()=>{
    ...
    formStore.userPlanChosen.plan.priceParMonth = formStore.plans[0].priceParMonth;
    formStore.userPlanChosen.plan.priceParYear = formStore.plans[0].priceParMonth * formStore.nbOfPayingMonthsPerYear;
})
